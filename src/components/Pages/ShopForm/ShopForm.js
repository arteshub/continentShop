            ...
            <div className="row">
                ...
                <div className="col">
                    <div className="form-group">
                        ...
                        <textarea  aria-describedby="i12" name="entry.462709995"  readOnly type="text" value={goodsItems }/>
                    </div>
                </div>
                ...
                <div className="col">
                    <div className="form-group">
                        ...
                        <input aria-describedby="i16" name="entry.635165254" readOnly value={`${totalPrice} сом`} type="text"/>
                    </div>
                </div>
                ...
                <div className="col">
                    <div className="form-group">
                        ...
                        <textarea autoComplete={'Введите Ваш адрес'} required={true} name="entry.46350536" aria-describedby="i20"></textarea>
                    </div>
                </div>
